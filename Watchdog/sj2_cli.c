...
void sj2_cli__init(void) {
  ...
  static app_cli__command_s cli__watchdog_new = {.command_name = "watchdog",
                                                 .help_message_for_command = "Task for watchdog suspend or resume \n",
                                                 .app_cli_handler = cli__watchdog};
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &cli__watchdog_new);
